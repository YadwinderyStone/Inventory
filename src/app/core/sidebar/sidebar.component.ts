...
import { Inventory } from '../domain-classes/inventory';
...
@Component({
  ...
  providers: [InventoryListComponent]
})
export class SidebarComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    private nextcomp: InventoryListComponent,
...
super(translationService);
  ...
  addInvenotry(inventory:Inventory) {
    this.nextcomp.addInvenotry(inventory);
  }
  setTopLogAndName() {
